...
if __name__ == '__main__':
    ...
    if args.gpu_id == -1:
        ctx = mx.cpu(0)
    test_net(args.root_path, args.dataset_path, args.prefix, args.epoch,
             args.batch_size, ctx, args.test_mode, args.thresh, args.min_face,
             args.stride, args.slide_window, args.shuffle, args.vis)
