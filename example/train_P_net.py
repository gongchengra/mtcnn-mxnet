...
def train_P_net(image_set, root_path, dataset_path, prefix, ctx, pretrained,
    ...
    train_net(sym, prefix, ctx, pretrained, epoch, begin_epoch, end_epoch,
              gt_imdb, 12, frequent, not resume, lr)


def parse_args():
    parser = argparse.ArgumentParser(
        description='Train proposal net(12-net)',
    ...
    parser.add_argument(
        '--pretrained',
        dest='pretrained',
        help='pretrained prefix',
        default='model/pnet',
        type=str)
    parser.add_argument(
        '--epoch', dest='epoch', help='load epoch', default=0, type=int)
    parser.add_argument(
        '--begin_epoch',
        dest='begin_epoch',
...
if __name__ == '__main__':
    ...
    train_P_net(args.image_set, args.root_path, args.dataset_path, args.prefix,
