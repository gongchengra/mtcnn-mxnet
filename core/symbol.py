...
def P_Net(mode='train'):
    ...
    conv1 = mx.symbol.Convolution(
        data=data, kernel=(3, 3), num_filter=10, name="conv1")
    ...
    conv2 = mx.symbol.Convolution(
        data=pool1, kernel=(3, 3), num_filter=16, name="conv2")
    prelu2 = mx.symbol.LeakyReLU(data=conv2, act_type="prelu", name="prelu2")

    conv3 = mx.symbol.Convolution(
        data=prelu2, kernel=(3, 3), num_filter=32, name="conv3")
    prelu3 = mx.symbol.LeakyReLU(data=conv3, act_type="prelu", name="prelu3")

    conv4_1 = mx.symbol.Convolution(
        data=prelu3, kernel=(1, 1), num_filter=2, name="conv4_1")
    conv4_2 = mx.symbol.Convolution(
        data=prelu3, kernel=(1, 1), num_filter=4, name="conv4_2")

    if mode == 'test':
        cls_prob = mx.symbol.SoftmaxActivation(
            data=conv4_1, mode="channel", name="cls_prob")
        bbox_pred = conv4_2
        ...
        cls_prob = mx.symbol.SoftmaxOutput(
            ...
            out_grad=True,
            name="cls_prob")
        conv4_2_reshape = mx.symbol.Reshape(
            data=conv4_2, shape=(-1, 4), name="conv4_2_reshape")
        bbox_pred = mx.symbol.LinearRegressionOutput(
            data=conv4_2_reshape,
            label=bbox_target,
            grad_scale=1,
            out_grad=True,
            name="bbox_pred")

        out = mx.symbol.Custom(
            cls_prob=cls_prob,
            bbox_pred=bbox_pred,
            label=label,
            bbox_target=bbox_target,
            op_type='negativemining',
...
def R_Net(mode='train'):
    ...
    conv1 = mx.symbol.Convolution(
        data=data, kernel=(3, 3), num_filter=28, name="conv1")
    prelu1 = mx.symbol.LeakyReLU(data=conv1, act_type="prelu", name="prelu1")
    pool1 = mx.symbol.Pooling(
        data=prelu1,
        pool_type="max",
    ...
    conv2 = mx.symbol.Convolution(
        data=pool1, kernel=(3, 3), num_filter=48, name="conv2")
    prelu2 = mx.symbol.LeakyReLU(data=conv2, act_type="prelu", name="prelu2")
    ...
    conv3 = mx.symbol.Convolution(
        data=pool2, kernel=(2, 2), num_filter=64, name="conv3")
    prelu3 = mx.symbol.LeakyReLU(data=conv3, act_type="prelu", name="prelu3")
    ...
    cls_prob = mx.symbol.SoftmaxOutput(
        data=fc2, label=label, use_ignore=True, out_grad=True, name="cls_prob")
    if mode == 'test':
        cls_prob = mx.symbol.SoftmaxOutput(
            data=fc2, label=label, use_ignore=True, name="cls_prob")
        bbox_pred = fc3
        group = mx.symbol.Group([cls_prob, bbox_pred])
    else:
        bbox_pred = mx.symbol.LinearRegressionOutput(
...
def O_Net(mode="train"):
    ...
    conv1 = mx.symbol.Convolution(
        data=data, kernel=(3, 3), num_filter=32, name="conv1")
    prelu1 = mx.symbol.LeakyReLU(data=conv1, act_type="prelu", name="prelu1")
    pool1 = mx.symbol.Pooling(
        data=prelu1,
        pool_type="max",
    ...
    conv2 = mx.symbol.Convolution(
        data=pool1, kernel=(3, 3), num_filter=64, name="conv2")
    prelu2 = mx.symbol.LeakyReLU(data=conv2, act_type="prelu", name="prelu2")
    pool2 = mx.symbol.Pooling(
        data=prelu2,
        pool_type="max",
    ...
    conv3 = mx.symbol.Convolution(
        data=pool2, kernel=(3, 3), num_filter=64, name="conv3")
    prelu3 = mx.symbol.LeakyReLU(data=conv3, act_type="prelu", name="prelu3")
    ...
    conv4 = mx.symbol.Convolution(
        data=pool3, kernel=(2, 2), num_filter=128, name="conv4")
